  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="h-screen bg-white dark:bg-gray-900 border-r-2 border-gray-200 dark:border-gray-800 flex flex-col relative shadow-xl"
        style={{
      ...
      >
        ...
        <motion.button
          ...
          className="absolute -right-3 top-4 w-6 h-6 bg-gray-900 dark:bg-gray-700 text-white rounded-full flex items-center justify-center shadow-xl z-10 hover:shadow-2xl transition-shadow"
        >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800">
          ...
          >
            <motion.div 
              ...
              className="w-8 h-8 bg-gray-900 dark:bg-gray-700 rounded-full flex items-center justify-center text-white font-bold text-xs shadow-md"
            >
              GS
            </motion.div>
            <AnimatePresence>
